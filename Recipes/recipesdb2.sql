...
grant all privileges on recipesdb2.* to 'baker'@'localhost';
...
insert into recipeImage values(2,'b','b','b.png',2);
insert into recipeImage values(3,'c','c','c.png',1);
insert into recipeImage values(4,'d','d','d.png',1);
insert into recipeImage values(5,'e','e','e.png',1);
insert into recipeImage values(6,'f',null,'f.png',null);
